...
_device_mapping: dict[str, DeviceInfo] = {
    ...
    # Sources:
    # - Intel ARK lists Max 1550 with 128 Xe-cores, 1600 MHz max dynamic
    #   clock, 128 GB HBM2e, 3276.8 GB/s memory bandwidth.
    # - Intel Xe-HPC architecture guide lists Data Center GPU Max 1550
    #   device-level throughput: FP32 MAD: 16384 * 2 FLOPs/clk.
    ...
    # Intel Data Center GPU Max 1100 / PVC (same generation as Max 1550)
    "INTEL DATA CENTER GPU MAX 1100": DeviceInfo(
        tops={
            torch.float64: 52.43,
            torch.float32: 52.43,
            "torch.tf32": 52.43,
...
_device_mapping["Intel(R) Data Center GPU Max 1100"] = _device_mapping[
